...
exports.getGeminiAnalysis = void 0;
const generative_ai_1 = require("@google/generative-ai");
const params_1 = require("firebase-functions/params");
const functions = __importStar(require("firebase-functions")); // Necesario para functions.logger.info
// Definir la variable de configuración
const geminiApiKey = (0, params_1.defineString)("GEMINI_API_KEY");
async function getGeminiAnalysis(code, inputLanguage, outputLanguage, analysisMode) {
...
exports.getGeminiAnalysis = getGeminiAnalysis;
